package cn.ismartv.tvhorizontalscrollview;
...
/**
 * Created by huaijie on 4/5/16.
 */
public class TvHorizontalScrollView extends FrameLayout {
    private static final String TAG = "TvHorizontalScrollView";
    ...
    private void childIsScroll() {
        ViewGroup parentView = (ViewGroup) getChildAt(0);
//        Rect parentRect = new Rect();
//        parentView.getGlobalVisibleRect(parentRect);

        View firstChildView = parentView.getChildAt(0);
//        Rect firstChildViewRect = new Rect();
//        firstChildView.getGlobalVisibleRect(firstChildViewRect);

        View lastChildView = parentView.getChildAt(parentView.getChildCount() - 1);
